...
export function ButtonMixin(name, selected, customClass) {
    this.name = name;
    this.selected = selected || false;
    this.customClass = customClass;
}

ButtonMixin.prototype = mixin({}, CustomEvents.prototype);

mixin(ButtonMixin.prototype, {
    constructor: ButtonMixin,
